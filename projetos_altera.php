...
<?php
  ...
  echo"<p><i>Atenção! Ao alterar os campos de um projetos certifique-se antes, através de uma consulta prévia no Banco de Dados</i></p>";
  echo"<form method='POST' action='projetos_alterado.php'>";
  echo"<b>Entre com o ID do projetos:</b><input type='text' name='id'size=3></p>";
