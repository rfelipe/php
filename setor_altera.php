...
<?php
  ...
  echo"<p><i>Atenção! Ao alterar os campos de um setor certifique-se antes, através de uma consulta prévia no Banco de Dados</i></p>";
  echo"<form method='POST' action='setor_alterado.php'>";
  echo"<b>Entre com o ID do setor:</b><input type='text' name='id'size=3></p>";
