...
<html>
<head>
<title>Exclusão de projetos</title><style type="text/css">
body {
...
echo"<h3>Exclusão de projetos</h3>";
echo"<form method='POST' action='projetos_excluido.php'>";
echo"<b>Entre com o codigo do projetos a ser excluido:</b><input type='text' name='categoria'size=3></p>";
