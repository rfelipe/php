...
<HTML>
<HEAD>
<TITLE>Cadastro de setor</TITLE><style type="text/css">
body {
...
echo"<h3>Inclusão de setor</h3><br>";
echo"<form method='POST' action='setor_inserir.php'>";
echo"<b>Novo setor....:</b><input type='text' name='desc_cat' size=20></p>";
