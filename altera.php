...
<?php
  ...
  echo"<h3>Alteração de Funcionários</h3>";
  echo"<p><i>Atenção! Ao alterar os campos do Funcionário certifique-se antes, através de uma consulta prévia no Banco de Dados</i></p>";
