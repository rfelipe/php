...
echo "&nbsp&nbspId_proj&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspProjeto";
echo"<hr align= center width=60%>";
$sql2 = ("SELECT cod_proj,desc_proj FROM projetos
ORDER BY `projetos`.`cod_proj`
");
...
<tr>
<td scope="col"><?php print $mostrar['cod_proj'];?></td>
